...
export const dict = {
  ...
  primaryNavigation: { en: "Primary navigation", sw: "Urambazaji mkuu" },
  logoAlt: { en: "Tanzania SOS logo", sw: "Nembo ya Tanzania SOS" },
  appTagline: { en: "Emergency & First Aid", sw: "Dharura na Huduma ya Kwanza" },
  locatingAddress: { en: "Locating address…", sw: "Inatafuta anwani…" },
  waitingGps: { en: "Waiting for GPS…", sw: "Inasubiri GPS…" },
  locationDenied: { en: "Location permission denied", sw: "Ruhusa ya eneo imekataliwa" },
  locationUnsupported: { en: "GPS is not supported on this device", sw: "GPS haitumiki kwenye kifaa hiki" },
  locationError: { en: "Could not get a GPS signal", sw: "Haikuweza kupata ishara ya GPS" },
  acquiringGps: { en: "Acquiring GPS signal…", sw: "Inatafuta ishara ya GPS…" },
  retry: { en: "Try again", sw: "Jaribu tena" },
  copyLocation: { en: "Copy location", sw: "Nakili mahali" },
  enRoute: { en: "en route", sw: "yuko njiani" },
  locatingYou: { en: "Locating you…", sw: "Inatafuta mahali ulipo…" },
  removeContact: { en: "Remove contact", sw: "Ondoa mtu" },
  contactName: { en: "Emergency contact name", sw: "Jina la mtu wa dharura" },
  contactPhone: { en: "Emergency contact phone", sw: "Simu ya mtu wa dharura" },
  hazardTitle: { en: "Nearby Hazard Reports", sw: "Ripoti za Hatari Karibu" },
  hazardMap: { en: "Map of nearby hazards", sw: "Ramani ya hatari zilizo karibu" },
  loadingMap: { en: "Loading map…", sw: "Inapakia ramani…" },
  active: { en: "active", sw: "hai" },
  enableGpsProximity: { en: "Enable GPS to sort by proximity", sw: "Washa GPS kupanga kwa umbali" },
  reportEmergency: { en: "Report Emergency", sw: "Ripoti Dharura" },
  filterHazards: { en: "Filter hazard categories", sw: "Chuja aina za hatari" },
  allHazards: { en: "All", sw: "Zote" },
  accidents: { en: "Accidents", sw: "Ajali" },
  flooding: { en: "Flooding", sw: "Mafuriko" },
  security: { en: "Security", sw: "Usalama" },
  recentReports: { en: "Recent Reports", sw: "Ripoti za Hivi Karibuni" },
  nearestFirst: { en: "Nearest first", sw: "Zilizo karibu kwanza" },
  noHazardReports: { en: "No reports in this category.", sw: "Hakuna ripoti katika aina hii." },
  stillThere: { en: "Still there", sw: "Bado Ipo" },
  share: { en: "Share", sw: "Shiriki" },
  verifiedHazard: { en: "Thank you — you confirmed this hazard is still there.", sw: "Asante — umethibitisha kuwa hatari bado ipo." },
  reportAdded: { en: "Report added to the map.", sw: "Ripoti imeongezwa kwenye ramani." },
  reportDescription: { en: "Report a nearby hazard. Your details will appear on the map.", sw: "Ripoti hatari iliyo karibu. Maelezo yako yataonekana kwenye ramani." },
  hazardCategory: { en: "Hazard category", sw: "Aina ya hatari" },
  nearestLandmark: { en: "Nearest landmark", sw: "Alama ya karibu" },
  landmarkPlaceholder: { en: "e.g. Jangwani Bridge", sw: "Mf. Daraja la Jangwani" },
  whatIsHappening: { en: "What is happening?", sw: "Nini kinatokea?" },
  hazardDetailPlaceholder: { en: "Briefly describe the hazard…", sw: "Eleza hatari kwa ufupi…" },
  optionalPhoto: { en: "Photo (optional)", sw: "Picha (si lazima)" },
  photoSelected: { en: "Photo selected", sw: "Picha imechaguliwa" },
  addPhoto: { en: "Add photo", sw: "Chagua picha" },
  cancel: { en: "Cancel", sw: "Ghairi" },
  submitReport: { en: "Submit Report", sw: "Tuma Ripoti" },
  reportPhotoAlt: { en: "Hazard reported near", sw: "Picha ya hatari karibu na" },
  recently: { en: "just now", sw: "sasa hivi" },
  pageNotFound: { en: "Page not found", sw: "Ukurasa haujapatikana" },
  pageNotFoundDesc: { en: "This page does not exist or has moved.", sw: "Ukurasa huu haupo au umehamishwa." },
  pageLoadFailed: { en: "This page did not load", sw: "Ukurasa huu haukufunguka" },
  pageLoadFailedDesc: { en: "Something went wrong. Try again or return home.", sw: "Hitilafu imetokea. Jaribu tena au rudi nyumbani." },
  goHome: { en: "Go home", sw: "Rudi nyumbani" },
